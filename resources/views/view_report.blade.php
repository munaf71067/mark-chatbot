                        ...
                        <div class=" mb-4">
                            <table class="table w-100 nowrap" id="dataTable">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th data-breakpoints="xs sm" class="text-center">Phone Number</th>
                                        <th data-breakpoints="xs sm md" class="text-center">Last Message</th>
                                        <th data-breakpoints="xs sm" class="text-center">Time</th>
                                        <th class="all" class="text-center">Bots Chat</th>
                                        {{-- <th data-breakpoints="xs sm">Agent Chats</th> --}}
                                        <th class="all" class="text-center">Agent Chats</th>
                                    </tr>
                                </thead>
                                <tbody>
