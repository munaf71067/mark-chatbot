  ...
  @section('title', 'List Key Search')
                        ...
                        <div class=" mb-4">
                            <table class="table w-100 nowrap" id="dataTable">
                                <thead>
                                    <tr>
                                        <th>ID</th>
                                        <th data-breakpoints="xs sm">Parent</th>
                                        <th data-breakpoints="xs sm md">Conv_id</th>
    ...
    @if($question->parent == 0)
        hi
    @else
        hi->{{ implode('->', $question->parent_titles) }}->{{ $question->title }}
    @endif
</td>
                                        ...
                                        <td>
                                            <p class="mb-0">{{ Str::limit($question->questions,30) }}</p>
