...
<body class="main-bg main-bg-opac main-bg-blur adminuiux-sidebar-fill-white adminuiux-sidebar-boxed  theme-blue roundedui" data-theme="theme-blue" data-sidebarfill="adminuiux-sidebar-fill-white" data-bs-spy="scroll" data-bs-target="#list-example" data-bs-smooth-scroll="true"
    tabindex="0">
    <!-- Pageloader -->
                            ...
                            <div class="px-2">
                                ...
                                <div>
                                    <a class="dropdown-item" href="{{route('dashboard')}}">
                                        <div class="row g-0">
                                            <div class="col align-self-center"><i data-feather="layout" class="avatar avatar-18 me-1"></i> My Dashboard
                                            </div>
                                            <div class="col-auto">
        ...
        <div class="adminuiux-sidebar">
            <div class="adminuiux-sidebar-inner">
                ...
                <ul class="nav flex-column menu-active-line">
                    ...
                    <i class="menu-icon bi bi-chat-left"></i>
                    <span class="menu-name">Questions</span>
                </a>
                        <div class="dropdown-menu">
                            <div class="nav-item">
                                <a href="{{route('view_question')}}" class="nav-link">
                            <i class="menu-icon bi bi-card-list"></i>
                            <span class="menu-name">Questions List</span>
                        </a>
                            </div>
                            <div class="nav-item">
                                <a href="{{route('add_question')}}" class="nav-link">
                            <i class="menu-icon bi bi-plus-circle"></i>
                            <span class="menu-name">Add Question</span>
                        </a>
                            </div>
                            <div class="nav-item">
                                <a href="{{route('configure_ai')}}" class="nav-link">
                            <i class="menu-icon bi bi-plus-circle"></i>
                            <span class="menu-name">Setup AI Answer</span>
                        </a>
                            </div>
                            {{-- <div class="nav-item">
                    ...
                    <span class="menu-name">Ques Search Word</span>
                </a>
                        <div class="dropdown-menu">
                            <div class="nav-item">
                                <a href="{{route('list_key_search')}}" class="nav-link">
                            <i class="menu-icon bi bi-card-list"></i>
                            <span class="menu-name">Ques Search Word list</span>
                        </a>
                            </div>
                            <div class="nav-item">
                                <a href="{{route('add_key_search')}}" class="nav-link">
                            <i class="menu-icon bi bi-plus-circle"></i>
                            <span class="menu-name">Add Ques Searc Word</span>
                        </a>
                            </div>
                            {{-- <div class="nav-item">
                                <a href="investment-deposit.html" class="nav-link">
                    ...
                    <span class="menu-name">Operator Panel</span>
                </a>
                    </li>
    ...
    <div class="offcanvas offcanvas-end shadow border-0" tabindex="-1" id="theming" data-bs-scroll="true" data-bs-backdrop="false" aria-labelledby="theminglabel">
        ...
        <div class="offcanvas-body">
            ...
            <div class="text-center mb-4">
                <a href="investment-personalization.html" class="btn btn-sm btn-outline-theme">More options <i class="bi bi-arrow-right-short"></i></a>
            </div>
        </div>
    </div>
